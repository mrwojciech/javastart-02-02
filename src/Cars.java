...
class Cars {
    public static void main(String[] args) {
        ...
        System.out.printf("Marka: %s, model: %s, rocznik: %d , pojemnosc: %.1f%n", car1.brand, car1.model, car1.year, car1.capacity);
        System.out.printf("Samochód 2:%n");
        System.out.printf("Marka: %s, model: %s, rocznik: %d , pojemnosc: %.1f", car2.brand, car2.model, car2.year, car2.capacity);
    }
}
